...
def generar_pdf_exacto(empresa, output_folder="pdfs_exactos"):
    """Genera un PDF usando la plantilla HTML"""
...
if __name__ == "__main__":
    ...
    if not empresas:
        ...
        for empresa in empresas:
            generar_pdf_exacto(empresa)
        
        print("\n¡Listo! Los PDFs están en la carpeta 'pdfs_exactos'")
